...
class NotamsScreenView extends GetView<NotamsScreenController> {
  const NotamsScreenView({super.key});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut<NotamsScreenController>(() => NotamsScreenController());
...
class _TopBar extends GetView<NotamsScreenController> {
  @override
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Row(
            children: [
              controller.parameters[ApiKeyConstants.mobileType] == "back"
                  ? InkWell(
...
class _TitleRow extends GetView<NotamsScreenController> {
  @override
  Widget build(BuildContext context) {
    return Padding(
...
class _Body extends GetView<NotamsScreenController> {
  @override
  Widget build(BuildContext context) {
...
class _NotamRow extends GetView<NotamsScreenController> {
  final Data item;
  final bool isLast;
