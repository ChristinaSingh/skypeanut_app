...
class CommonWidgets {
  ...
  static Widget dataNoNotificationFound() {
    return Center(
      child: Image.asset(ImageConstants.imageNoNotificationFound,
      height: 100,
      width: 100,),
    );
  }
                      ...
                      child: TextFormField(
                        ...
                        style: style ??
                            Theme.of(Get.context!)
                                ...
                                .headlineMedium
                                ?.copyWith(
                                    fontSize: 14.px, color: textColorLite),
    ...
    Color? selectedFillColor,
      ...
      PinCodeTextField(
        ...
        pinTheme: PinTheme(
          ...
          activeFillColor: Color(0XFFF5F4F8),
          selectedColor: primaryColor2,
          selectedFillColor:  Color(0XFFF5F4F8),
